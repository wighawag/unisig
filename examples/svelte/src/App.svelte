...
<main>
  ...
  <p class="subtitle">Demonstrating fine-grained reactivity with property-level tracking</p>
    ...
    <div class="main-content">
      {#if selectedPlayerId}
        ...
        <div class="explanation">
          ...
          <ul>
            <li><strong>Each property has its own render count</strong> - Watch them carefully!</li>
            ...
            <li>The Player List only re-renders when you <strong>add/remove</strong> players</li>
          </ul>
          <p class="note">
            This granular reactivity is achieved using <code>trackItemProp()</code> and 
            <code>triggerItemProp()</code> - each property has its own signal!
          </p>
        </div>
      {:else}
        <div class="placeholder">
          <p>👈 Select a player from the list to see property-level reactivity in action</p>
        </div>
      {/if}
    </div>
  </div>
...
<style>
  ...
  .add-player h3, .select-player h3 {
    margin-top: 0;
    font-size: 1em;
    color: #333;
  }
